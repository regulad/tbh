...
public class TbhCreatureEntity extends TamableAnimal implements RangedAttackMob {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.CREATURE).add(new MobSpawnSettings.SpawnerData(TbhModEntities.TBH_CREATURE.get(), 18, 3, 4));
	}

	public TbhCreatureEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TbhModEntities.TBH_CREATURE.get(), world);
	}
	...
	public SoundEvent getHurtSound(DamageSource ds) {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("tbh:yippee"));
	}
	...
	public boolean hurt(DamageSource source, float amount) {
		TbhCreatureEntityIsHurtProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		TbhCreatureEntity retval = TbhModEntities.TBH_CREATURE.get().create(serverWorld);
