...
public class TbhModItems {
	...
	public static final RegistryObject<Item> TBH_CREATURE_SPAWN_EGG = REGISTRY.register("tbh_creature_spawn_egg", () -> new ForgeSpawnEggItem(TbhModEntities.TBH_CREATURE, -1, -16777216, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
